...
function EditUser({update, updatefunc, cancel}) {
 

 
  const [newUser, setNewUser] = useState(update[0]);
  ...
  return (
    <>
      <div className="wrapper">
        <form onSubmit={(e) =>updatefunc(newUser, e)} id="wizard">
          <h4>Update {newUser.firstname} info</h4>
          <section>
            <div className="inner">
              ...
              <button className="btn-custom" type="submit"  >Update</button>
              &nbsp;
